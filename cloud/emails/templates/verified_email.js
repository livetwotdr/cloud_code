          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #ffffff; border-radius: 20px;">
            <tr>
              <td class="content-cell">
                ...
                Thank you for verifying your email address with us! We're excited to have you on board and look forward to providing you with the best experience possible. Your account is now fully activated, and you can take full advantage of all the features available.<br><br>
                If you have any questions or need assistance, feel free to reach out to our support team here: ${support_email}.
              </td>
            </tr>
          </table>
        </td>
