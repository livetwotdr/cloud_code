...
function resetPasswordEmailTamplate(appName, header_logo_url, code, first_name, support_email, company_name, support_address, year) {
  ...
  <head>
    ...
    <title>New account Verification Code</title>
    <style>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #ffffff; border-radius: 20px;">
            <tr>
              <td class="content-cell">
                Hi ${first_name},<br><br>
                Your verification code to signup for new account is <b>${code}</b>. Don’t share this with anyone. If you didn’t registered a new account, you can ignore this email.
              </td>
            </tr>
          </table>
        </td>
