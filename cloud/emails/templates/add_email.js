...
function resetPasswordEmailTamplate(appName, header_logo_url, code, first_name, support_email, company_name, support_address, year) {
  ...
  <head>
    ...
    <title>Add email Verification Code</title>
    <style>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #ffffff; border-radius: 20px;">
            <tr>
              <td class="content-cell">
                Hi ${first_name},<br><br>
                Your verification code to add email to account is <b>${code}</b>. Don’t share this with anyone. If you didn’t asked to add new email in your account, you can ignore this email.
              </td>
            </tr>
          </table>
        </td>
