...
const LogoUrl = "https://livetwo.info/ic_logo_boom.png"; // App logo url, used in emails header
...
const Address = "Alampur, Suti, Murshidabad, Pin-742223 (W.B), IN"; //  Comapany address, used in emails footer
